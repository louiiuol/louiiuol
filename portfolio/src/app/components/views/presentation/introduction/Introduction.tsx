        ...
        <section className="container cols start tabs no-overflow">
            ...
            <section className="container evenly reverse noflex">
                ...
                <div className="is-white spaced-lg halfwidth-md no-overflow">
                    ...
                    <p className='animate__animated animate__flipInX animate__delay-3s spaced-xs' >Je suis actuellement à la recherche d’un CDI en tant que développeur full stack Javascript. Si mon profi vous intéresse, n'hésitez pas à me contacter !</p>
                </div>
            </section>
        </section>
    );
